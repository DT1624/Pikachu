...
//const int h_w = 50;//w và h của 1 ô
//const int row = 18; //số cột
//const int column = 11; // số hàng
//const int FPS = 60;
...
//
//const SDL_Rect PLAY_MENU = {430, 332, 240, 96};
//const SDL_Rect SCORE_MENU = {430, 462, 240, 96};
//const SDL_Rect INTRO_MENU = {430, 592, 240, 96};
//
//const SDL_Rect MENU_WAIT = {430, 332, 240, 96};
...
//};
//
//Point first_Move, second_Move, tmp1, tmp2;
//
//void reset_Game()
//{
//    score = 0;
...
//{
//    vector<pair<Point, Point>> st_A = checkX(A, B);
...
//            if(arr[i][j] > 0)
//            {
//                string s = "1/" + to_string(arr[i][j]) + "_down.png";
...
//                    first_Check = false;
//                    sound_Turn();
//                    renderTexture("1/" + to_string(arr[tmp2.x][tmp2.y]) + "_up.png", convertX(tmp2.y), convertY(tmp2.x), h_w, h_w);
//                }
...
//                    first_Check = true;
//                    sound_Turn();
//                    renderTexture("1/" + to_string(arr[tmp1.x][tmp1.y]) + "_up.png", convertX(tmp1.y), convertY(tmp1.x), h_w, h_w);
//                }
//            }
//        }
//
...
//
//    load_Font("Top 1 : " + to_string(rank_score[0]), 210, 330, 180, 70, LIME_COLOR);
//    load_Font("Top 2 : " + to_string(rank_score[1]), 210, 410, 180, 70, LIME_COLOR);
//    load_Font("Top 3 : " + to_string(rank_score[2]), 210, 490, 180, 70, LIME_COLOR);
//    load_Font("Top 4 : " + to_string(rank_score[3]), 465, 300, 180, 70, LIME_COLOR);
//    load_Font("Top 5 : " + to_string(rank_score[4]), 465, 370, 180, 70, LIME_COLOR);
//    load_Font("Top 6 : " + to_string(rank_score[5]), 465, 450, 180, 70, LIME_COLOR);
//    load_Font("Top 7 : " + to_string(rank_score[6]), 465, 530, 180, 70, LIME_COLOR);
//    load_Font("Top 8 : " + to_string(rank_score[7]), 720, 330, 180, 70, LIME_COLOR);
//    load_Font("Top 9 : " + to_string(rank_score[8]), 720, 410, 180, 70, LIME_COLOR);
//    load_Font("Top 10 : " + to_string(rank_score[9]), 720, 490, 180, 70, LIME_COLOR);
//}
//
//void print_INTRO()
//{
...
//                {
//                    renderTexture("1/" + to_string(arr[tmp2.x][tmp2.y]) + "_down.png", convertX(tmp2.y), convertY(tmp2.x), h_w, h_w);
//                    renderTexture("1/" + to_string(arr[tmp1.x][tmp1.y]) + "_down.png", convertX(tmp1.y), convertY(tmp1.x), h_w, h_w);
//                    sound_NoDelete();
//                }
//            }
//            first_Move = {0, 0};
